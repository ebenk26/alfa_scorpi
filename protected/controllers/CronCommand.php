							...
							else
							{
								...
								if(isset($res[11]))
								{
									...
									if($array[0] && isset($array[1])){
										...
										$return .= "Format jam dan tanggal tidak ada spasi ";
										echo "Format jam dan tanggal tidak ada spasi";
										$errormail->save();
										// exit();
									}
								}else{
									...
									$return .= "Jumlah hashtag '#' kurang dari 11 ";
									echo  "Jumlah hashtag '#' kurang dari 11 ";
									$errormail = new ErrorGrabMail;
									$criteria = new CDbCriteria;  
									$criteria->addCondition("email = '".$from."' and password = '".$password."'");
									$user = User::model()->find($criteria);
