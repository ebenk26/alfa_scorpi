...
class Dealer extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('nama, alamat, email, created_by, updated_by', 'length', 'max'=>255),
			array('created_at, updated_at, deleted_at', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, nama, alamat, email, region_id, created_by, updated_by, created_at, updated_at, deleted_at', 'safe', 'on'=>'search'),
		);
	}
