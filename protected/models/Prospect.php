...
class Prospect extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('nama_stnk, no_ro, nik, nama, alamat, ttl, no_hp, tipe, dp, jam_survey, keterangan, case_number, from_email, udate, dp_approve, cicil_approve, tenor, ganti_jam_survey, status_telepon, created_by, updated_by', 'length', 'max'=>255),
			array('foto_ro,profil_konsumen,nama_surveyor,tipe_approve,keterangan_approve,nama_stnk, no_ro, bid_from_time, foto_1, foto_2, foto_3, note, created_at, updated_at, deleted_at, case_id_reblast, nama_salesman, id', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, nik, nama, alamat, ttl, no_hp, tipe, dp, jam_survey, keterangan, case_number, region_id, user_id, from_email, udate, status, bid_from_time, has_winner, foto_1, foto_2, foto_3, note, dp_approve, cicil_approve, tenor, ganti_jam_survey, status_telepon, created_by, updated_by, created_at, updated_at, deleted_at', 'safe', 'on'=>'search'),
			array('foto_1', 'file', 'types'=>'jpg,png','allowEmpty'=>true, 'maxSize'=>5000000, 'tooLarge'=>'File has to be smaller than 500mb','safe' => true,'on'=>'update'),
			array('foto_2', 'file', 'types'=>'jpg,png','allowEmpty'=>true, 'maxSize'=>5000000, 'tooLarge'=>'File has to be smaller than 500mb','safe' => true,'on'=>'update'),
			array('foto_3', 'file', 'types'=>'jpg,png','allowEmpty'=>true, 'maxSize'=>5000000, 'tooLarge'=>'File has to be smaller than 500mb','safe' => true,'on'=>'update'),
			array('foto_ro,no_ro', 'required', 'on' => 'update'),
			// array('foto_ro,no_ro', 'required', 'when' => function($model) {
   //              return isset($model->no_ro);
   //          }),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'foto_3' => 'Foto 3',
			'note' => 'Note',
			'dp_approve' => 'Dp Yang Disetujui',
			'cicil_approve' => 'Cicilan Yang Disetujui',
			'tenor' => 'Tenor',
			...
			'no_ro' => 'No. RO/CRO',
			'foto_ro' => 'Foto RO',
			'nama_surveyor' => 'Nama Surveyor (CMO)',
			'tipe_approve' => 'Tipe Motor',
			'keterangan_approve' => 'Keterangan Approve',
			'profil_konsumen' => 'Profil Konsumen',
			'case_id_reblast' => 'Case ID Reblast',
			'last_case_id' => 'Last Case ID Reblast',
